...
//    CGFloat batteryLevel = [QBDeviceInfo batteryLevel];
    ...
    _wifiMsgArr = [[NSArray alloc] initWithObjects:wifiName,ipAddress,wifiIpAddress,dns,networkType,telephonyCarrier,mobileCountryCode,mobileNetworkCode, nil];
...
- (void)setupFoldingTableView{
    ...
    YUFoldingTableView *foldingTableView = [[YUFoldingTableView alloc] initWithFrame:CGRectMake(0, 64, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - 64 - 49)];
