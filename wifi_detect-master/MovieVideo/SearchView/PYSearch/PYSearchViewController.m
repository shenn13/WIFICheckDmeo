...
- (void)setup{
    ...
    searchBar.layer.borderColor = [[UIColor colorWithRed:0.0/255 green:180.0/255 blue:255.0/255 alpha:1] CGColor];
...
- (void)setHotSearches:(NSArray *)hotSearches
{
    ...
    if (self.hotSearchStyle == PYHotSearchStyleRankTag) { // 带有排名的标签
